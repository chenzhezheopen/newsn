	...
	var parentfun = function parentfun(){
		...
		if($("#select-value1",parent.document).val()!="开始时间"&&$("#select-value2",parent.document).val()!="结束时间"){
			var arr1 = $("#select-value1",parent.document).val().split("-")
			var arr2 = $("#select-value2",parent.document).val().split("-")
			var days = daysBetween($("#select-value1",parent.document).val(),$("#select-value2",parent.document).val());
			if(days<0){
